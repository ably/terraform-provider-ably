...
// ListApps lists all apps for the given account.
...
// CreateApp creates a new app in the given account.
...
// UpdateAppPKCS12 uploads a PKCS12 certificate for the app.
...
// GetAppStats returns stats for the given app.
