...
// Step 1: Create w/ params (appName=autogenerated, key_name=autogenerated, capabilities.0=publish, capabilities.1=subscribe)
// Step 2: Update w/ params  (appName=autogenerated, key_name=autogenerated, capabilities.0=history)
func TestAccAblyKey(t *testing.T) {
	...
	update_key_name := "acc-test-" + appName
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAblyKeyConfig(appName, key_name, "channel100", `["publish", "subscribe"]`, true),
			...
			{
				Config: testAccAblyKeyConfig(updateAppName, update_key_name, "channel100", `["history"]`, false),
				Check: resource.ComposeAggregateTestCheckFunc(
