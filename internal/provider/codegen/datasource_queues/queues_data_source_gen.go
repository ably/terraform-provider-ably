...
func QueuesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"queues": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"name": schema.StringAttribute{
							...
							MarkdownDescription: "The friendly name of the queue.",
						},
						"region": schema.StringAttribute{
							Computed:            true,
							Description:         "The data center region for the queue.",
							MarkdownDescription: "The data center region for the queue.",
						},
...
func (t QueuesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	amqpAttribute, ok := attributes["amqp"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`amqp is missing from object`)

		return nil, diags
	}

	amqpVal, ok := amqpAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`amqp expected to be basetypes.ObjectValue, was: %T`, amqpAttribute))
	}
	...
	deadletterAttribute, ok := attributes["deadletter"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`deadletter is missing from object`)

		return nil, diags
	}

	deadletterVal, ok := deadletterAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`deadletter expected to be basetypes.BoolValue, was: %T`, deadletterAttribute))
	}

	deadletterIdAttribute, ok := attributes["deadletter_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`deadletter_id is missing from object`)

		return nil, diags
	}

	deadletterIdVal, ok := deadletterIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`deadletter_id expected to be basetypes.StringValue, was: %T`, deadletterIdAttribute))
	}
	...
	maxLengthAttribute, ok := attributes["max_length"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`max_length is missing from object`)

		return nil, diags
	}

	maxLengthVal, ok := maxLengthAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`max_length expected to be basetypes.Int64Value, was: %T`, maxLengthAttribute))
	}

	messagesAttribute, ok := attributes["messages"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`messages is missing from object`)

		return nil, diags
	}

	messagesVal, ok := messagesAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`messages expected to be basetypes.ObjectValue, was: %T`, messagesAttribute))
	}
	...
	statsVal, ok := statsAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`stats expected to be basetypes.ObjectValue, was: %T`, statsAttribute))
	}

	stompAttribute, ok := attributes["stomp"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`stomp is missing from object`)

		return nil, diags
	}

	stompVal, ok := stompAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`stomp expected to be basetypes.ObjectValue, was: %T`, stompAttribute))
	}
	...
	return QueuesValue{
		Amqp:         amqpVal,
		AppId:        appIdVal,
		Deadletter:   deadletterVal,
		DeadletterId: deadletterIdVal,
		Id:           idVal,
...
func (v QueuesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["amqp"] = basetypes.ObjectType{
		AttrTypes: AmqpValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["app_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["deadletter"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["deadletter_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["max_length"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["messages"] = basetypes.ObjectType{
		AttrTypes: MessagesValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["region"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["state"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["stats"] = basetypes.ObjectType{
		AttrTypes: StatsValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["stomp"] = basetypes.ObjectType{
		AttrTypes: StompValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Amqp.ToTerraformValue(ctx)
		...
		val, err = v.Deadletter.ToTerraformValue(ctx)
		...
		val, err = v.DeadletterId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["deadletter_id"] = val
		...
		val, err = v.MaxLength.ToTerraformValue(ctx)
		...
		val, err = v.Messages.ToTerraformValue(ctx)
		...
		val, err = v.Stomp.ToTerraformValue(ctx)
...
func (v QueuesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var amqp basetypes.ObjectValue

	if v.Amqp.IsNull() {
		amqp = types.ObjectNull(
			AmqpValue{}.AttributeTypes(ctx),
		)
	}

	if v.Amqp.IsUnknown() {
		amqp = types.ObjectUnknown(
			AmqpValue{}.AttributeTypes(ctx),
		)
	}

	if !v.Amqp.IsNull() && !v.Amqp.IsUnknown() {
		amqp = types.ObjectValueMust(
			AmqpValue{}.AttributeTypes(ctx),
			v.Amqp.Attributes(),
		)
	}

	var messages basetypes.ObjectValue

	if v.Messages.IsNull() {
		messages = types.ObjectNull(
			MessagesValue{}.AttributeTypes(ctx),
		)
	}

	if v.Messages.IsUnknown() {
		messages = types.ObjectUnknown(
			MessagesValue{}.AttributeTypes(ctx),
		)
	}

	if !v.Messages.IsNull() && !v.Messages.IsUnknown() {
		messages = types.ObjectValueMust(
			MessagesValue{}.AttributeTypes(ctx),
			v.Messages.Attributes(),
		)
	}

	var stats basetypes.ObjectValue

	if v.Stats.IsNull() {
		stats = types.ObjectNull(
			StatsValue{}.AttributeTypes(ctx),
		)
	}

	if v.Stats.IsUnknown() {
		stats = types.ObjectUnknown(
			StatsValue{}.AttributeTypes(ctx),
		)
	}

	if !v.Stats.IsNull() && !v.Stats.IsUnknown() {
		stats = types.ObjectValueMust(
			StatsValue{}.AttributeTypes(ctx),
			v.Stats.Attributes(),
		)
	}

	var stomp basetypes.ObjectValue

	if v.Stomp.IsNull() {
		stomp = types.ObjectNull(
			StompValue{}.AttributeTypes(ctx),
		)
	}

	if v.Stomp.IsUnknown() {
		stomp = types.ObjectUnknown(
			StompValue{}.AttributeTypes(ctx),
		)
	}

	if !v.Stomp.IsNull() && !v.Stomp.IsUnknown() {
		stomp = types.ObjectValueMust(
			StompValue{}.AttributeTypes(ctx),
			v.Stomp.Attributes(),
		)
	}
	...
	attributeTypes := map[string]attr.Type{
		"amqp": basetypes.ObjectType{
			AttrTypes: AmqpValue{}.AttributeTypes(ctx),
		},
		"app_id":        basetypes.StringType{},
		"deadletter":    basetypes.BoolType{},
		"deadletter_id": basetypes.StringType{},
		"id":            basetypes.StringType{},
		"max_length":    basetypes.Int64Type{},
		"messages": basetypes.ObjectType{
			AttrTypes: MessagesValue{}.AttributeTypes(ctx),
		},
		"name":   basetypes.StringType{},
		"region": basetypes.StringType{},
		"state":  basetypes.StringType{},
		"stats": basetypes.ObjectType{
			AttrTypes: StatsValue{}.AttributeTypes(ctx),
		},
		"stomp": basetypes.ObjectType{
			AttrTypes: StompValue{}.AttributeTypes(ctx),
		},
...
func (v QueuesValue) Equal(o attr.Value) bool {
	...
	if !v.Deadletter.Equal(other.Deadletter) {
		return false
	}

	if !v.DeadletterId.Equal(other.DeadletterId) {
		return false
	}
	...
	if !v.MaxLength.Equal(other.MaxLength) {
		return false
	}

	if !v.Messages.Equal(other.Messages) {
		return false
	}
